    ...
    <div className="space-y-6 animate-fade-in">
      ...
      {isLoading ? (
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 rounded-3xl p-6 sm:p-8 text-white shadow-xl space-y-6 border border-slate-800">
            <div className="flex items-center justify-between opacity-90 border-b border-white/10 pb-4">
              ...
              <span className="text-xs bg-white/10 px-3 py-1 rounded-full font-mono text-indigo-200 border border-white/10">
                {date}
              </span>
            </div>
